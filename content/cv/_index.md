...
- Drove upstream multi-modal research exceeding S$15M in computational social analytics for reasoning and understanding.
...
- Integrated low-power communications modules — 3G/4G LTE, Iridium SBD satcoms, sub-GHz wireless radio — with GPS geo-positioning and remote sensing (acoustic, EO) for long-endurance IoT deployments.
- Implemented an ultra-low power NB wireless protocol via novel smart-preamble wake-on-radio architecture.
